...
if __name__ == "__main__":
    ...
    cull_scan(scan, ply_file, result_mesh_file, args.data_path)

    cmd = f"python evaluation/eval.py --data {result_mesh_file} --scan {scan} --mode mesh --dataset_dir {Offical_DTU_Dataset} --vis_out_dir {out_dir}"
    os.system(cmd)
